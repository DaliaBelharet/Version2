...
function Footer() {
  const footerStyle = {
    backgroundColor: '#FFA500', // Couleur d'orange
  ...
  const columnStyle = {
    ...
    flexWrap: 'wrap', // Pour s'assurer que les colonnes passent à la ligne si nécessaire
    marginBottom: '20px', // Espacement entre les colonnes
  };
